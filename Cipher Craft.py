...
headingLabel = Label(headingFrame1, text=" Welcome to CipherCraft", fg='grey19', font=('Courier',15,'bold'))
...
def Result():
  ...
  if (i==1):
    ...
    messagebox.showinfo('CipherCraft', 'Please Choose one of Encryption or Decryption. Try again.')
